angular.module('cloneDir', ["viewService"])
.controller('CloneDirCtrl', ['$scope','$window','$routeParams','$location','ViewService', function($scope,$window, $routeParams, $location, ViewService){
